...
const navigation = [
  { name: "Helmet", href: "#", current: false },
  { name: "Goggles", href: "#", current: false },
  { name: "Jackets", href: "#", current: false },
  { name: "Trousers", href: "#", current: false },
  { name: "Base Layer", href: "#", current: false },
];
